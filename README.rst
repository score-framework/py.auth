...
you allowed to do this?") for your SCORE application.

The `narrative documentation of score.auth`__ contains all the information you
need to put this module to good use.

__ http://www.score-framework.org/doc/python/auth/
